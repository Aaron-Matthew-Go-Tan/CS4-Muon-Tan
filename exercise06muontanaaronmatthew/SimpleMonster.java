...
public class SimpleMonster {
    //I changed the access modifiers of some of these fields to "protected" in order to facilitate object declaration using the subclasses.
    protected final String name;
    protected String type, strongAgainst, weakAgainst;
